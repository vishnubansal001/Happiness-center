...
export default function ArchiveListing() {
  ...
  async function onSubmit(e) {
    ...
    async function storeImage(image) {
      ...
      const docRef = await addDoc(collection(db, "archiveListing"), formDataCopy);
      toast.success("Added Archive Images");
      navigate("/admin/events/archive")
