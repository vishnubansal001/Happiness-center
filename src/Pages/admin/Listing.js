        ...
        <div className="flex items-center justify-center gap-2 w-full h-full">
          <div className="flex items-start justify-center w-full  h-full md:flex-row flex-col">
            ...
            <div className="flex items-center justify-start  p-4 h-full flex-col w-full md:w-[80%]">
              <div className="bg-white shadow-sm flex items-center justify-center p-2">
                  ...
                  events?.map((event) => (
                    ...
                    >
                      <div className="flex items-center justify-center gap-2 p-2 border lg:w-[75%] rounded-lg flex-col">
                        ...
                        <div className="flex items-center justify-center">
                          {" "}
                          <h1 className="font-semibold font-base uppercase">
                            {event.data.eventName}
                          </h1>
                        </div>
                        <div className="flex items-center justify-center">
                          {" "}
                          <p className="font-medium font-base uppercase">
                            {event.data.eventDate}
                          </p>
                        </div>
                        <div className="flex items-center justify-between gap-2 flex-row lg:w-[85%]">
                          <div className="flex items-center justify-center gap-3 flex-row">
                            <div className="flex items-center justify-center p-2">
                              <Moment
                                className="bg-[#3377cc] text-white uppercase text-[.75rem] font-semibold rounded-md p-2 shadow-md"
                                fromNow
                              >
                                {event.data.timestamp?.toDate()}
                              </Moment>
                            </div>
                            <div className="flex items-center justify-center">
                              {" "}
                            ...
                            <div className="flex items-center justify-center">
                              ...
                              {onEdit && (
                                <MdEdit
                                  className="h-[1rem] cursor-pointer text-green-500"
                          ...
                          <Link
                            key={event.id}
                            to={`/admin/events/listing/${event.id}/happiness2023`}
                          >
                            <button
                              type="submit"
