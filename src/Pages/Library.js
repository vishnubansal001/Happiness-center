...
export default function Library() {
  ...
  },[validEmail,validRoll,validDate,validPhone,validName, validTime, validBook])
  ...
  return (
    <section className="h-full w-screen flex relative items-center justify-center font-zilla">
        ...
        <div className="h-full w-full flex flex-col items-center justify-center">
          <div className="h-full w-full  md:w-[65%] lg:w-[60%] xl:w-1/2 flex flex-col items-center justify-center gap-4">
            ...
            <div className="w-[85%] sm:w-[65%] md:w-[75%] lg:w-[65%] flex flex-col items-center justify-center gap-1">
             ...
             {dFocus ?  <div className="flex items-center justify-start text-xs text-red-400 w-full p-1"><p className="text-start w-full p-1 font-semibold">{dateHelper}</p></div> : null}
            </div>
            <div className="w-[85%] sm:w-[65%] md:w-[75%] lg:w-[65%] flex flex-col items-center justify-center gap-1">
              <div className="w-full flex items-center justify-start p-2">
                <label className="xxs:text-sm sm:text-md flex justify-start items-start w-3/4 uppercase font-medium">
             ...
             {tFocus ?  <div className="flex items-center justify-start text-xs text-red-400 w-full p-1"><p className="text-start w-full p-1 font-semibold">{timeHelper}</p></div> : null}
            </div>
            <div className="w-[85%] sm:w-[65%] md:w-[75%] lg:w-[65%] flex flex-col items-center justify-center gap-1">
              <div className="w-full flex items-center justify-start p-2">
                <label className="xxs:text-sm sm:text-md flex justify-start items-start w-3/4 uppercase font-medium">
             ...
             {bFocus ?  <div className="flex items-center justify-start text-xs text-red-400 w-full p-1"><p className="text-start w-full p-1 font-semibold">{bookHelper}</p></div> : null}
            </div>
      ...
      <div className="hidden sm:flex items-center justify-center absolute  bottom-0 right-0 z-[-1]">
          <img src={vector9} alt="vector color art" className="w-48 h-48 md:w-56 md:h-56 lg:w-64 lg:h-64" /> 
        </div>
      ...
      <div className="hidden sm:flex items-center justify-center absolute  bottom-0 left-0 z-[-1]">
          <img src={flower4} alt="vector color art" className="w-52 h-52 lg:w-56 lg:h-56" /> 
        </div>
    </section>
  );
}
