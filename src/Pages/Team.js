    ...
    >
      ...
      >
       <div class="flex items-center justify-center rounded-full p-1 border-2 border-red-500">
          <img
            class="rounded-full h-24 w-24 object-left"
            src="https://avatars.githubusercontent.com/u/92084737?s=400&u=b72cd8c67b041952cc4145ca1f19926b41729833&v=4"
            alt="photo"
          />
        </div>
        <div class="text-center py-4 gap-2 w-full flex items-center justify-center flex-col">
          <p class="text-xl text-gray-700 font-bold">Yakshit</p>
          <p class="text-base text-gray-500 font-medium">Position</p>
          <p class="text-sm w-[85%] text-center text-gray-400 font-normal">"lorem ipsum dolor sit amet, consectetur adipiscing lorem ipsum dolor."</p>
        </div>
        <div
