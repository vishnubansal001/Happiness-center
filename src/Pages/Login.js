          ...
          <div className="flex bg-gray-800 justify-center my-12 w-full h-full rounded-md items-center flex-wrap px-6 py-12 max-w-6xl mx-auto gap-8">
            ...
            <div className="w-full md:w-[67%] lg:w-[40%] flex justify-center gap-2 flex-col p-2">
              ...
              <div className="flex items-center justify-center">
                <h1 className="text-2xl text-center font-bold text-white p-2">
                  Sign In
                </h1>
              </div>
              <form
              ...
              >
                ...
                <button
                  type="submit"
                  className="w-full bg-blue-600 text-white px-7 py-3 text-sm sm:text-lg font-medium uppercase rounded shadow-md hover:bg-blue-700 transition duration-150 ease-in-out hover:shadow-lg active:bg-blue-800"
                >
                  Sign In
                </button>
              </form>
